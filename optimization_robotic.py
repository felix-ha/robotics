...
class GradientDescent(Optimizer):
    def __init__(self, max_iterations=1000,
                 constant_step_length=0.001,
                 epsilon_gradient=0.001,
                 robot=None):
        ...
        self.robot = robot
        self.coordinates_destination = np.array([self.robot.coordinates_destination.x,
                                                self.robot.coordinates_destination.y])
    ...
    def optimize(self, f, x_0):
        ...
        x_tcp, y_tcp = self.robot.forward_kinematic(x)
